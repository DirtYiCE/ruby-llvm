...
module LLVM
  module C
    ...
    # Memory buffers
    attach_function :LLVMCreateMemoryBufferWithContentsOfFile, [:string, :pointer, :pointer], :bool
    attach_function :LLVMCreateMemoryBufferWithSTDIN, [:pointer, :pointer], :bool
